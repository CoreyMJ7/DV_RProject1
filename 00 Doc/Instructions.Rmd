...
#####5. Use a query statement in the  TitanicAnalysis.R file (in data folder) to build one or more data frame with the titanic data from the Oracle     database. 
...
#####8. Call these files in a .Rmd file using R markdown commands and press Knit HTML to view the data/plots. (Code seen below)
